...
import org.tonysgt.model.weather.WeatherAppError;
...
public class WeatherServiceImpl implements WeatherService {
    ...
    public Response forecast(String lat, String lon){
        try {
            ...
            ).sorted(Comparator.comparing(Forecast::getTimestamp)).toList();
            ...
            WeatherAppError weatherAppError = new WeatherAppError(e.getStatus(), message);
            return Response.status(e.getStatus()).entity(weatherAppError).build();
        }
